...
class Wrapper_9025086239142465949;
thread_local Wrapper_9025086239142465949 *simHandle9025086239142465949;
...
public:
    ...
    Wrapper_9025086239142465949(const char * name, const char * wavePath, int seed){
      //contextp = new VerilatedContext;
      Verilated::randReset(2);
      Verilated::randSeed(seed);
      top = new VSimAsynchronousDut();

      simHandle9025086239142465949 = this;
      time = 0;
      timeCheck = 0;
    ...
    virtual ~Wrapper_9025086239142465949(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/test/adder_tree/MySpinalProject/./simWorkspace/SimAsynchronousDut/$TEST/") + name + ".dat").c_str());
      #endif
...
double sc_time_stamp () {
  return simHandle9025086239142465949->time;
}
...
JNIEXPORT Wrapper_9025086239142465949 * API JNICALL Java_wrapper_1verilator_VerilatorNative_newHandle_19025086239142465949
  (JNIEnv * env, jobject obj, jstring name, jstring wavePath, jint seedValue){
    ...
    Wrapper_9025086239142465949 *handle = new Wrapper_9025086239142465949(ch, wavePathCh, seedValue);
    env->ReleaseStringUTFChars(name, ch);
    env->ReleaseStringUTFChars(wavePath, wavePathCh);
    return handle;
}

JNIEXPORT jboolean API JNICALL Java_wrapper_1verilator_VerilatorNative_eval_19025086239142465949
  (JNIEnv *, jobject, Wrapper_9025086239142465949 *handle){
   handle->top->eval();
   return Verilated::gotFinish();
}

JNIEXPORT jint API JNICALL Java_wrapper_1verilator_VerilatorNative_getTimePrecision_19025086239142465949
  (JNIEnv *, jobject, Wrapper_9025086239142465949 *handle){
  return handle->time_precision;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_sleep_19025086239142465949
  (JNIEnv *, jobject, Wrapper_9025086239142465949 *handle, uint64_t cycles){
  #ifdef TRACE
...
JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64_19025086239142465949
  (JNIEnv *, jobject, Wrapper_9025086239142465949 *handle, int id){
  return handle->signalAccess[id]->getU64();
}

JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64mem_19025086239142465949
  (JNIEnv *, jobject, Wrapper_9025086239142465949 *handle, int id, uint64_t index){
  return handle->signalAccess[id]->getU64_mem(index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64_19025086239142465949
  (JNIEnv *, jobject, Wrapper_9025086239142465949 *handle, int id, uint64_t value){
  handle->signalAccess[id]->setU64(value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64mem_19025086239142465949
  (JNIEnv *, jobject, Wrapper_9025086239142465949 *handle, int id, uint64_t value, uint64_t index){
  handle->signalAccess[id]->setU64_mem(value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_deleteHandle_19025086239142465949
  (JNIEnv *, jobject, Wrapper_9025086239142465949 * handle){
  delete handle;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8_19025086239142465949
  (JNIEnv * env, jobject obj, Wrapper_9025086239142465949 * handle, jint id, jbyteArray value){
  handle->signalAccess[id]->getAU8(env, value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8mem_19025086239142465949
  (JNIEnv * env, jobject obj, Wrapper_9025086239142465949 * handle, jint id, jbyteArray value, uint64_t index){
  handle->signalAccess[id]->getAU8_mem(env, value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8_19025086239142465949
  (JNIEnv * env, jobject obj, Wrapper_9025086239142465949 * handle, jint id, jbyteArray value, jint length){
  handle->signalAccess[id]->setAU8(env, value, length);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8mem_19025086239142465949
  (JNIEnv * env, jobject obj, Wrapper_9025086239142465949 * handle, jint id, jbyteArray value, jint length, uint64_t index){
  handle->signalAccess[id]->setAU8_mem(env, value, length, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_enableWave_19025086239142465949
  (JNIEnv *, jobject, Wrapper_9025086239142465949 * handle){
  handle->waveEnabled = true;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_disableWave_19025086239142465949
  (JNIEnv *, jobject, Wrapper_9025086239142465949 * handle){
